...
- **Secondary (#6B5B50):** Приглушённый тёплый земляной — мета-данные, footer, подписи. Держит иерархию, не отвлекает. Контраст ≥ 4.5:1 на neutral и surface (WCAG AA для текста).
...
- Обложка = один целостный кадр, не коллаж. Утверждённая база: hero-wide.jpg (десктоп, ≥721px) + hero-mobile.jpg (мобильный, ≤720px) — два файла из одного исходника.
...
- **Do** использовать hero-wide.jpg (десктоп, ≥721px) и hero-mobile.jpg (мобильный, ≤720px) как набор hero-фото из одного исходника.
...
- **Don't** генерировать коллаж из разных локаций — hero-фото (hero-wide.jpg + hero-mobile.jpg) = один целостный кадр, два кропа.
- **Don't** менять позу/ракурс/силуэт женщины из hero-wide.jpg / hero-mobile.jpg — она остаётся точь-в-точь.
...
- **Канон:** один целостный кадр (hero-wide.jpg + hero-mobile.jpg). Не смешивать локации, не добавлять фантазийные элементы.
