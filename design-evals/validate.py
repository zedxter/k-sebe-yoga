...
Usage:
  ...
  python3 design-evals/validate.py
...
def run():
    ...
    print(f"{'='*72}\n")
    print(f"[INFO] Screenshots always generated. Exiting 0 (artifacts uploaded to CI).")
    print(f"[NOTE] Token failures ({grand_failures}) are reported above for reference.")
    sys.exit(0)
